...
> salas (Projetos) separadas: o Harvey Reginald Specter de Milan (o PROMPT-MESTRE de roleplay
> e estratégia é a identidade), com cérebro plástico de seis camadas, habilidades por nível,
> decisões pelo próprio caráter e dez bibliotecas
...
> mantém o próprio ([`gpt_projeto/upload_mesas/M01/`](gpt_projeto/upload_mesas/M01/)); todos com
> vida e risco real de morrer, sem volta (o memorial fica em `upload_cemiterio/`),
...
> `python -m nucleo` aplica os blocos de aprendizado que os setores emitem,
...
> e o ciclo de vida de novos setores, e regenera as três salas para reenvio.
>
