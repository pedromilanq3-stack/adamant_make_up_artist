...
|---|---|---|---|
| HARVEY | v001 (522cefb627ee) | v001 | `nucleo versoes reverter HARVEY v001 --autorizado-por-milan` |
...
| LOBO | v001 (223ef601a5d3) | v001 | `nucleo versoes reverter LOBO v001 --autorizado-por-milan` |
| M01 | v001 (8d992440a2e4) | v001 | `nucleo versoes reverter M01 v001 --autorizado-por-milan` |
...
A última versão estável de cada setor é a baseline mais recente em versoes/. Alteração crítica exige baseline, teste controlado, comparação antes e depois e ordem expressa de Milan para produção.
