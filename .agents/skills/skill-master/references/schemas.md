...
This document defines the JSON schemas used by the eval/benchmark system.
...
```json
{
  ...
  "notes": ["Skill adds 13s average execution time but improves pass rate by 50%"]
}
```
...
```json
{
  ...
  "loser_weaknesses": ["Vague instruction led to inconsistent behavior", "No script for validation, agent had to improvise"],
  ...
  "improvement_suggestions": [
    {
      ...
      "suggestion": "Replace vague phrasing with explicit steps",
