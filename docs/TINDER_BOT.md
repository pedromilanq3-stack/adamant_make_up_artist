...
versão (atualmente `1.2.0`), ativada. Várias cópias podem criar timers e observadores
...
Na versão 1.2.0 ou posterior, recupere o painel sem reinstalar pressionando
...
com o Tampermonkey no Firefox. Por isso, a versão 1.2.0 não depende de comandos extras
...
Na versão 1.2.0, o nome e a idade também podem ser identificados em texto comum quando
